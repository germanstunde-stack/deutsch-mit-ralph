...
export const topics: TopicMeta[] = [
  { id: "alfabeto", icon: "🔤", name: "Alfabeto", cardTitle: "📖 Das Alphabet",
    explanationHTML: "<p>26 letras + <b class='de'>ä ö ü</b> (Umlaut). Na Suíça o alfabeto para aí: o <b class='de'>ß</b> da Alemanha <b>não existe aqui</b> — escreve-se sempre <b class='de'>ss</b>. Nos exercícios, ouça a palavra e ache a letra que falta.</p>" },
  ...
  { id: "cumprimentos", icon: "👋", name: "Cumprimentos", cardTitle: "📖 Grüsse & Alltag",
    explanationHTML: "<p>Saudações e frases do dia a dia. Cuidado com <b class='de'>du</b> (informal) × <b class='de'>Sie</b> (formal).</p>" },
  { id: "tamanhos", icon: "📏", name: "Tamanhos", cardTitle: "📖 Gegenteile & Masse",
