...
const sentencesPT: Record<string, [string, string][]> = {
  [CH_EU_VOCE_SEIN]: [
    ...
    ["Er ist aus Basel.", "Ele é da Basileia."],
  ],
  [CH_VERBOS_HABEN]: [
    ["Ich komme aus Brasilien.", "Eu venho do Brasil."],
    ["Wir wohnen in Zürich.", "Nós moramos em Zurique."],
  ...
  [CH_ARTIGOS]: [
    ...
    ["Unsere Schwester wohnt in Zürich.", "Nossa irmã mora em Zurique."],
  ],
  [CH_PREPOSICOES]: [
    ["Ich komme aus Brasilien.", "Eu venho do Brasil."],
...
const sentencesEN: Record<string, [string, string][]> = {
  [CH_EU_VOCE_SEIN]: [
    ...
    ["Er ist aus Basel.", "He is from Basel."],
  ],
  [CH_VERBOS_HABEN]: [
    ["Ich komme aus Brasilien.", "I come from Brazil."],
    ["Wir wohnen in Zürich.", "We live in Zurich."],
  ...
  [CH_ARTIGOS]: [
    ...
    ["Unsere Schwester wohnt in Zürich.", "Our sister lives in Zurich."],
  ],
  [CH_PREPOSICOES]: [
    ["Ich komme aus Brasilien.", "I come from Brazil."],
