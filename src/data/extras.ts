...
export const sentences: Record<string, [string, string][]> = {
  alfabeto: [["Ich heisse Ralph.", "Meu nome é Ralph."], ["Wie schreibt man das?", "Como se escreve isso?"], ["Buchstabiere bitte!", "Soletre, por favor!"]],
  numeros: [["Ich bin dreissig Jahre alt.", "Tenho trinta anos."], ["Es ist drei Uhr.", "São três horas."], ["Das kostet zehn Franken.", "Custa dez francos."], ["Ich möchte zwei Kaffee.", "Quero dois cafés."]],
  ...
  animais: [["Der Hund ist gross.", "O cachorro é grande."], ["Die Katze ist klein.", "O gato é pequeno."], ["Das Pferd läuft schnell.", "O cavalo corre rápido."], ["Der Vogel singt.", "O pássaro canta."]],
  comidas: [["Das Brot ist frisch.", "O pão está fresco."], ["Der Kaffee ist heiss.", "O café está quente."], ["Ich esse einen Apfel.", "Eu como uma maçã."], ["Der Wein ist gut.", "O vinho é bom."]],
  ...
  tamanhos: [["Der Elefant ist gross.", "O elefante é grande."], ["Ich kaufe ein Kilo Tomaten.", "Compro um quilo de tomates."], ["Die Flasche hat einen Liter.", "A garrafa tem um litro."], ["Es sind zehn Kilometer.", "São dez quilômetros."]],
...
export function sentencesForTopic(id: string, profile: Profile | null): [string, string][] {
  ...
  if (id === "alfabeto" && profile?.display_name) {
    ...
    return [[`Ich heisse ${nome}.`, `Meu nome é ${nome}.`], ...base.slice(1)];
  }
