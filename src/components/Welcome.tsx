  ...
  return (
    <div className="login-wrap">
      <div className="login cadastro welcome">
        ...
        <p style={{ marginBottom: 4 }}>🇩🇪 GermanStunde é pra falantes de português aprenderem alemão do zero — desde a alfabetização.</p>
        ...
        <div className="welcome-section">
          ...
          {isStandalone ? (
            ...
            <>
              ...
              <button className="btn primary" onClick={promptInstall}>⬇️ Instalar GermanStunde</button>
            </>
          ) : isIOS ? (
